...
ASGI_APPLICATION = "socialnetworking.asgi.application"
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "SOCIALNETWORKING V1 ADMIN",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SOCIALNETWORKING V1",
    ...
    "welcome_sign": "Welcome to the Socialnetworking v1 Admin Section",
    # Copyright on the footer
    "copyright": "Socialnetworking v1 Ltd",
    ...
    "usermenu_links": [
        {"name": "SOCIALNETWORKING V1 FrontPage", "url": FRONTEND_URL, "new_window": True},
        {"model": "accounts.user"},
    ],
    #############
    # Side Menu #
